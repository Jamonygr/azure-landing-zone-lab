...
| Security and compliance | Trivy, Checkov, Gitleaks, Conftest | `.github/workflows/terraform.yml`, `policies/` |
...
- Confirm generated Terraform documentation has no drift.
- Review SARIF outputs for Trivy and Checkov.
...
- Post Azure-free static and security summaries to PRs for faster review feedback.
