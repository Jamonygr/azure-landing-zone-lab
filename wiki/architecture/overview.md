...
- The 5-pillar architecture: Networking, Identity Management, Governance, Security, and Management.
...
|--------|--------------|----------------|
| **1. Networking** | `landing-zones/networking/` | Hub VNet, Azure Firewall, VPN Gateway, Application Gateway, VNet Peering, NAT Gateway |
| **2. Identity Management** | `landing-zones/identity-management/` | Domain Controllers (DC01, DC02), DNS servers, Identity VNet |
| **3. Governance** | `landing-zones/governance/` | Management Groups, Azure Policy, Cost Management, RBAC custom roles, Regulatory Compliance (HIPAA/PCI-DSS) |
| **4. Security** | `landing-zones/security/` | Shared Services VNet, Key Vault, Storage Account, SQL Database, Private DNS Zones, Private Endpoints |
| **5. Management** | `landing-zones/management/` | Jumpbox VM, Log Analytics, Monitoring/Alerts, Backup, Automation, Workload zones (Prod/Dev) |
