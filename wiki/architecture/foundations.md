...
- Managed identities: the default identity for Automation, workloads, policy assignments, and supported Azure resources.
...
- Missing permissions: keep optional policy, management-group, and role-assignment features disabled until their specific roles are intentionally granted.
- OIDC failures: verify the federated subject matches the selected protected GitHub environment.
