...
| `azure_client_id` | string | Yes | - | Entra app client ID for OIDC |
| `azure_tenant_id` | string | Yes | - | Entra tenant ID |
...
2. Logs into Azure using GitHub OIDC
3. Exports ARM OIDC environment variables
