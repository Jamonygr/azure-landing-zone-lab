...
- `workload_prod_container_apps_subnet_prefix` - delegated subnet prefix for Container Apps (default: `10.10.8.0/23`)
...
| `deploy_container_apps` | `false` | Deploy Container Apps managed environment and sample app | ~$0-5/mo |
